...
<head>
  ...
  <script src='../js/JsonQuestionCounter.js'></script>
...
<body>
  ...
  <?php
    if(!$logeatuta){
      ...
      echo "<div class='scrolable'>
      <div id='showCurrentUsers'> Nire galderak/Galderak guztira (JSON) datu basean: <span id='nireGalderak'> 0 </span> / <span id='guztiraGalderak'> 0 </span>  </div>
      <input type='button' name='showQuestionsButton' id='showQuestionsButton' value='Show' onclick='ShowQuestionsJsonAjax()'>
        <form id='galderenF' enctype='multipart/form-data' name='galderenF'>
          ...
          <input type='button' name='submitButton' id='submitButton' value='Bidali' onclick='AddQuestionAjax()'>
          <input type='reset' name='hustu' id='hustu' value='Hustu'><br>

        </form>
        <div id='egoera'></div>
        <div id='jsongaldera' class='tableContainer'></div>
      </div>";
    }else{
